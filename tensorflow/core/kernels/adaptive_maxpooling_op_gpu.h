...
#ifndef TENSORFLOW_CORE_KERNELS_ADAPTIVE_MAXPOOLING_OP_GPU_H_
#define TENSORFLOW_CORE_KERNELS_ADAPTIVE_MAXPOOLING_OP_GPU_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_ADAPTIVE_MAXPOOLING_OP_GPU_H_
